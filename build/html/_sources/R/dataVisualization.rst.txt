...
~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   数据可视化是一种将数字转化为有用的知识的艺术。通过使用R，可以通过一组内置函数和库来构建可视化效果并显示数据，从而帮助决策之。虽然已经有些Oracle BIEE、Tableau、Echart、D3.js等专用工具，但是还是需要有类似R、Python这类具有良好可视化功能的**建模/统计**工具，帮助您进行任何探索性数据分析。 
