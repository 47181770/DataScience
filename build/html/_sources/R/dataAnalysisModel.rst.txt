...
============= ========================
    ...
    1. AIC输出赤池信息统计量，AIC(Akaike Information Criterion)赤池信息准则是衡量统计模型拟合优良性的一种标准，由日本统计学家赤池弘次在1974年提出。建立在熵的概念上，提供了权衡估计模型复杂度和拟合数据优良性的标准。也就是说逐步回归分析以AIC信息统计量为准则，通过选择最小的AIC信息统计量来达到删除或者增加变量的目的。
